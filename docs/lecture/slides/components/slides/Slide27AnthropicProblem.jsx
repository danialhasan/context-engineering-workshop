...
const Slide27AnthropicProblem = () => (
  <ResearchOverviewSlide
    company="Anthropic"
    goal="High reliability over long-horizon autonomous work"
    focusLabel="Problem"
    focusText="Long-running work breaks across discrete context windows"
    accent="indigo"
  />
);

export default Slide27AnthropicProblem;
