...
const Slide28AnthropicConstraints = () => (
  <ResearchLabSlide
    ...
    accent="indigo"
    bullets={[
      "Tasks span many windows, so handoff quality directly determines reliability.",
      "Context budget is finite; compaction alone is not always sufficient.",
      "Each run must leave merge-ready, auditable state for the next run."
    ]}
  />
);

export default Slide28AnthropicConstraints;
