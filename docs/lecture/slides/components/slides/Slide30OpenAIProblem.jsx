...
const Slide30OpenAIProblem = () => (
  <ResearchOverviewSlide
    company="OpenAI"
    goal="Reproducible, high-quality autonomous coding in real repos"
    focusLabel="Problem"
    focusText="Strong model outputs fail without harness legibility"
    accent="emerald"
  />
);

export default Slide30OpenAIProblem;
