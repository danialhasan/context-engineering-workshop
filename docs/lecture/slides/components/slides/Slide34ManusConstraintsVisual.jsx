...
const Slide34ManusConstraintsVisual = () => (
  <ResearchDiagramSlide
    title="Manus: Constraints Visual"
    subtitle="KV-cache economics dominate long-horizon runtime performance"
    imageSrc={manusKvCache}
    imageAlt="Manus design around KV-cache diagram"
  />
);

export default Slide34ManusConstraintsVisual;
