  ...
  <BaseSlide containerClassName="items-center justify-center" panelClassName="w-[95%] h-[85%]">
    ...
    <div className="grid grid-cols-2 gap-[2.5%] flex-1">
      <div className="bg-indigo-50 border border-indigo-200 rounded-[1vw] p-[3%] shadow-sm">
        <p className="text-[clamp(1.1rem,1.5vw,1.8rem)] font-bold text-indigo-700 uppercase tracking-wider mb-[1.5%]">Mode 1: single agent</p>
      ...
      <div className="bg-rose-50 border border-rose-200 rounded-[1vw] p-[3%] shadow-sm">
        <p className="text-[clamp(1.1rem,1.5vw,1.8rem)] font-bold text-rose-700 uppercase tracking-wider mb-[1.5%]">Mode 2: swarm</p>
      ...
      <div className="bg-white/80 border border-slate-200 rounded-[1vw] p-[3%] shadow-sm">
        <p className="text-[clamp(1.1rem,1.5vw,1.8rem)] font-bold text-emerald-700 uppercase tracking-wider mb-[1.5%]">Execution loop</p>
        <p className="text-[clamp(1.15rem,1.55vw,1.8rem)] text-slate-700 font-medium leading-snug">Observe → retrieve → act → verify → write back. Repeat until completion criteria are proven.</p>
      </div>
      <div className="bg-white/80 border border-slate-200 rounded-[1vw] p-[3%] shadow-sm">
        <p className="text-[clamp(1.1rem,1.5vw,1.8rem)] font-bold text-amber-700 uppercase tracking-wider mb-[1.5%]">Output</p>
        <p className="text-[clamp(1.15rem,1.55vw,1.8rem)] text-slate-700 font-medium leading-snug">A working harness pattern attendees can reuse with their own datasets and tools.</p>
      </div>
    </div>
  </BaseSlide>
);
