...
const Slide27AnthropicProblemVisual = () => (
  <ResearchDiagramSlide
    title="Anthropic: Session Handoff"
    subtitle="Memory resets across discrete sessions without explicit handoff artifacts"
    imageSrc={anthropicSessionHandoffNanobanana}
    imageAlt="Anthropic-style diagram showing session handoff memory loss and drift"
  />
);

export default Slide27AnthropicProblemVisual;
